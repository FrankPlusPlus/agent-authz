...
| An ambient HTTP(S) proxy receives PDP payloads | The standard transport disables implicit process proxy discovery | Configure the PDP endpoint as an approved egress gateway; do not rely on developer/workstation proxy state |
