...
```bash
python -m pip install "agent-authz-sdk[fastapi] @ git+https://github.com/FrankPlusPlus/agent-authz.git@v0.7.0b1"
```
...
```bash
python -m pip install "agent-authz-sdk[mcp] @ git+https://github.com/FrankPlusPlus/agent-authz.git@v0.7.0b1"
```
